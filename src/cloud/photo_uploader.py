...
class PhotoUploader:
    ...
    def __init__(self, supabase_url: str, supabase_key: str, bucket_name: str = 'attendance-photos'):
        """
    ...
    def upload_photo(self, local_path: str, student_id: str) -> Optional[str]:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                # Generate public URL
                public_url = f"{self.storage_url}/object/public/{self.bucket_name}/{cloud_path}"

...
class DetectionLogger:
    ...
    def log_event(self, event: FaceDetectionEvent) -> None:
        ...
        logger.info(f"Detection logged: {event.face_count} faces, {len(event.photos)} photos")
    ...
    def get_summary(self) -> dict:
        ...
        return {
            ...
            'average_faces_per_event': total_faces / total_detections if total_detections > 0 else 0
        }

...
for i, student in enumerate(test_students, 1):
    ...
    logger.info(f"Student: {student['name']} | {student['grade']} - {student['section']}")
    ...
    photo_path.write_text(f"SIMULATED PHOTO\nStudent: {student['name']}\nTime: {datetime.now()}\n")
...
if records:
    ...
    for record in records:
        ...
        print(f"  • {record[0]} | {record[1]} | {record[2]} | {record[3]} | {sync_status}")
